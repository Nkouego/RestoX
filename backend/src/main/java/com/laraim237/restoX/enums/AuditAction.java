...
public enum AuditAction {
    ...
    STAFF_DEACTIVATED, STAFF_ACTIVATED, INVITE_RESENT, STAFF_DELETED,
    ...
    // Restaurant
    RESTAURANT_CREATED, RESTAURANT_UPDATED, RESTAURANT_ARCHIVED, RESTAURANT_ACTIVATED, RESTAURANT_DEACTIVATED, 
}
